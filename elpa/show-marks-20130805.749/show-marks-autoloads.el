...

;;;### (autoloads nil "show-marks" "show-marks.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "show-marks" '("show-mark" "mark-" "goto-nth-mark")))
